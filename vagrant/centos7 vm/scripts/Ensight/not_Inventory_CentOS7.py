...
def get_soft():
    ...
    for software in softwares:
        ...
        return version_vendor_list
var007 = get_soft()

allcontent= {'Softwares':var007,'DomainName':va1,'ReportDateTime':var100,'Disks':dev_to_disk_space,'DNSHostName':var1,'Manufacturer':var2,'Model': var3,'NumberOfLogicalProcessors':var4,'NumberOfProcessors': var5,'OperatingSystem':[{'Description':var6,'ProductName':var7,'Vendor':var8,'Version':var9,'Processor':var10,'System OS':var11}], 'Nics':[{'IPAddress':ip_Address,'DHCPServerIPAddress':vari,'DNSDomain':FQD_name,'MACAddress':ip_mac_Address,'SubnetMask':netmask_Addr}]}
